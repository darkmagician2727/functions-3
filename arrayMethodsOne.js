...
// CODE HERE
const totalPopulation = populations.reduce((totalPopulation, element) => totalPopulation + element)
...
const ordersTotal = orders.map((element) => element.price * (1 + element.tax))
